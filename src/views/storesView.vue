        ...
        <div class ="header ">
            ...
            <div class="col-md-3 mt-3">
                <select v-model="selected">
                    <option style="background-color: white;" disabled value="">LIST STORES BY DATE</option>
            ...
            <div class="col-md-3 mt-3">
                <select v-model="selected">
                    <option  style="background-color: white;" disabled value="">LIST ALL CATEGORIES</option>
